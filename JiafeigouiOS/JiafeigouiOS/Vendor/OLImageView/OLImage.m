...
- (id)initWithCGImageSource:(CGImageSourceRef)imageSource scale:(CGFloat)scale
{
    ...
    self.loopCount = [gifProperties[(__bridge NSString *)kCGImagePropertyGIFLoopCount] unsignedIntegerValue];
...
+ (instancetype)imageWithIncrementalData:(NSData *)data
{
    ...
    image.totalDuration = 0;
    image.frameDurations = (NSTimeInterval *)calloc(1, sizeof(NSTimeInterval));
...
- (void)updateDurations
{
    ...
    NSTimeInterval *durations = (NSTimeInterval *)calloc(count, sizeof(NSTimeInterval));
