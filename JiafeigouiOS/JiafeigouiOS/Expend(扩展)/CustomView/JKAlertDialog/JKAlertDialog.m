...
-(void)buildViews{
    ...
    //title
    CGFloat labelHeigh = [self heightWithString:_title fontSize:15 width:AlertWidth-2*AlertPadding];
    _labelTitle = [[UILabel alloc]initWithFrame:CGRectMake(AlertPadding, AlertPadding, AlertWidth-2*AlertPadding, labelHeigh)];
    _labelTitle.font = [UIFont systemFontOfSize:TitleLabelFontSize];
    ...
    if (_title == nil || [_title isEqualToString:@""]) {
        _labelTitle.frame = CGRectMake(AlertPadding, AlertPadding*0.5, AlertWidth-2*AlertPadding, 0);
    }
    ...
    _labelmessage.font = [UIFont systemFontOfSize:MessageLabelFontSize];
    ...
    if (_message == nil || [_message isEqualToString:@""]) {
        _labelmessage.frame = CGRectMake(AlertPadding, _labelTitle.frame.origin.y+_labelTitle.frame.size.height, AlertWidth-2*AlertPadding, 0);
    }
...
//        button.translatesAutoresizingMaskIntoConstraints = NO;
        ...
        if (item.type == Button_Bold) {
            button.titleLabel.font = [UIFont boldSystemFontOfSize:ButtonTitleFontSize+1];
        }else{
