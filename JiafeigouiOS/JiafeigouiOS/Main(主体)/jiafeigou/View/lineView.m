...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextMoveToPoint(context, (selfWidth -lineWidth) /2, 0);  //将路径绘制的起点移动到一个位置，即设置线条的起点
    CGContextAddLineToPoint(context, (selfWidth -lineWidth) /2, selfHeight);  //在图形上下文移动你的笔画来指定线条的终点
