...
//    self.oldFrame = CGRectMake(oriX, oriY, oriWidth, oriHeight);
    ...
    quxiaoBtn.frame = CGRectMake(15, shadeView.bounds.size.height-25-25, 40, 30);
    ...
    quedingBtn.frame = CGRectMake(shadeView.bounds.size.width-40-15, shadeView.bounds.size.height-25-25, 40, 30);
    [quedingBtn setTitle:@"使用" forState:UIControlStateNormal];
